...
def draw_landmarks(image, results):
    ...
    mp_drawing.draw_landmarks(image, results.face_landmarks, mp_holistic.FACEMESH_TESSELATION,              # On face
                             mp_drawing.DrawingSpec(color=(204,228,248), thickness=1, circle_radius=1),       # Landmark color
